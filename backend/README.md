...
## Project Structure
    ...
    ├── testapiautoconnecto_68936  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_68936`
...
2. Clone this repo and `cd testapiautoconnecto_68936`
